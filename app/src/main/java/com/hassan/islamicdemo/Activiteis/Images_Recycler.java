...
public class Images_Recycler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageList.add(new Images(R.drawable.q1,"حفظ الصورة","مشاركة الصورة ","تعيين خلفية"));
        imageList.add(new Images(R.drawable.q22,"حفظ الصورة","مشاركة الصورة ","تعيين خلفية"));
        imageList.add(new Images(R.drawable.q33,"حفظ الصورة","مشاركة الصورة ","تعيين خلفية"));
