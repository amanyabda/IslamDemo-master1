...
public class Page_two extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageList.add(new Images(R.drawable.e1,"حفظ الصورة","مشاركة الصورة ","تعيين خلفية"));
        imageList.add(new Images(R.drawable.e2,"حفظ الصورة","مشاركة الصورة ","تعيين خلفية"));
        imageList.add(new Images(R.drawable.e3,"حفظ الصورة","مشاركة الصورة ","تعيين خلفية"));
