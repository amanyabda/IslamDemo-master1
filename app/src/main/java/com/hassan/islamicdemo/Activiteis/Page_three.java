...
public class Page_three extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageList.add(new Images(R.drawable.f,"حفظ الصورة","مشاركة الصورة ","تعيين خلفية"));
        imageList.add(new Images(R.drawable.f1,"حفظ الصورة","مشاركة الصورة ","تعيين خلفية"));
        imageList.add(new Images(R.drawable.f3,"حفظ الصورة","مشاركة الصورة ","تعيين خلفية"));
